...
// let xPhrases = phrases.filter(v => v.includes('x'));
// xph = getPhrases(xPhrases, 5);
// console.log(xph);

// let zPhrases = phrases.filter(v => v.includes('z'));
// zph = getPhrases(zPhrases, 5);
// console.log(zph);

// let qPhrases = phrases.filter(v => v.includes('q'));
// qph = getPhrases(qPhrases, 5);
// console.log(qph);

// let jPhrases = phrases.filter(v => v.includes('j'));
// jph = getPhrases(jPhrases, 5);
// console.log(jph);
// j,q,x,zの回数を増やす
// 予備軍：b(13),k(13),v(10)

// let bPhrases = phrases.filter(v => v.includes('b'));
// bph = getPhrases(bPhrases, 10);
// console.log(bph);

// let kPhrases = phrases.filter(v => v.includes('k'));
// kph = getPhrases(kPhrases, 10);
// console.log(kph);

// let xbPhrases = phrases.filter(v => v.includes('x') && v.includes('b'));
// xbph = getPhrases(xbPhrases, 10);
// console.log(xbph);

// let xkPhrases = phrases.filter(v => v.includes('x') && v.includes('k'));
// xkph = getPhrases(xkPhrases, 10);
// console.log(xkph);

// let xvPhrases = phrases.filter(v => v.includes('x') && v.includes('v'));
// xvph = getPhrases(xvPhrases, 10);
// console.log(xvph);

let xPhrases = phrases.filter(
  v =>
    v.includes('x') &&
    !(v.includes('z') || v.includes('q') || v.includes('j')) &&
    (v.includes('b') || v.includes('k') || v.includes('v'))
);
// xph = getPhrases(xPhrases, 10);
console.log('x-bkv');
console.log(getPhrases(xPhrases, 10));

let zPhrases = phrases.filter(
  v =>
    v.includes('z') &&
    !(v.includes('x') || v.includes('q') || v.includes('j')) &&
    (v.includes('b') || v.includes('k') || v.includes('v'))
);
// zph = getPhrases(zPhrases, 10);
console.log('z-bkv');
console.log(zPhrases);

let zzPhrases = phrases.filter(
  v =>
    v.includes('z') &&
    !(v.includes('x') || v.includes('q') || v.includes('j')) &&
    !(v.includes('b') || v.includes('k') || v.includes('v'))
...
// zph = getPhrases(zPhrases, 10);
console.log('!z-bkv');
console.log(getPhrases(zzPhrases, 3));

let qPhrases = phrases.filter(
  v =>
    v.includes('q') &&
    !(v.includes('z') || v.includes('x') || v.includes('j')) &&
    (v.includes('b') || v.includes('k') || v.includes('v'))
);
// qph = getPhrases(qPhrases, 10);
console.log('q-bkv');
console.log(getPhrases(qPhrases, 10));

let jPhrases = phrases.filter(
  v =>
    v.includes('j') &&
    !(v.includes('z') || v.includes('q') || v.includes('x')) &&
    (v.includes('b') || v.includes('k') || v.includes('v'))
);
console.log('j-bkv');
console.log(getPhrases(jPhrases, 10));
// [
//   'did you see that spectacular explosion',
//   'keep receipts for all your expenses',
//   'February has an extra day',
...
//   'historic meeting without a result'
// ];
// console.log(getPhrases(phrases, 20));
