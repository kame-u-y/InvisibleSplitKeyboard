...
const { nanriInvisible } = require("./tapData/nanri/nanri-invisible.js");
const { sabuInvisible } = require("./tapData/sabu/sabu-invisible.js");
const { yutaroInvisible } = require("./tapData/yutaro/yutaro-invisible.js");
const { manoInvisible } = require("./tapData/mano/mano-invisible.js");
...
function validate(trainIds, testId) {
  ...
  fs.writeFileSync(
    `./wordAccuracy-invisible-${testId}.json`,
