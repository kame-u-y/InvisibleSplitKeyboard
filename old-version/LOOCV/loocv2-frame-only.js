...
const { nanriFrameOnly } = require("./tapData/nanri/nanri-frame-only.js");
const { sabuFrameOnly } = require("./tapData/sabu/sabu-frame-only.js");
const { yutaroFrameOnly } = require("./tapData/yutaro/yutaro-frame-only.js");
const { manoFrameOnly } = require("./tapData/mano/mano-frame-only.js");
...
function validate(trainIds, testId) {
  ...
  fs.writeFileSync(
    `./wordAccuracy-frame-only-${testId}.json`,
